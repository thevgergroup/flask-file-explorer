...
file_explorer_bp = Blueprint(
    "flask_file_explorer", __name__, template_folder="templates", static_folder="static"
)
...
def index():
    ...
    return render_template(
        "flask-file-explorer/index.html", base_directory=base_directory
    )
...
def browse():
    ...
    if os.path.isdir(full_path):
        ...
        if request.args.get("path", "") != "":
            return render_template(
                "flask-file-explorer/listings.html",
        ...
        return render_template(
            "flask-file-explorer/index.html",
            base_directory=base_directory,
            path=path,
            files=files,
        )
